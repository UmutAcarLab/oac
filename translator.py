...
def translate(i, o):
  circ = QuantumCircuit.from_qasm_file(i)
...
def translate_bench (bn):
  path = "benchmarks/" + bn + "/"
  bench_file = path +  bn + ".qasm.preprocessed"
  target_file = path + bn + ".clifft.qasm"
  if os.path.exists(target_file):
    print(bn, " translation already exists")
  else:
    print(bn, "translating")
    translate(bench_file, target_file)
