...
# Run QUESO normal
java --enable-preview -cp ./queso/SymbolicOptimizer-1.0-SNAPSHOT-jar-with-dependencies.jar Applier -c $1 -g nam -r ./queso/rules_q3_s6_nam.txt -sr ./queso/rules_q3_s3_nam_symb.txt -t $2 -j "nam"
