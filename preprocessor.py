...
def lopt (path, bench_name, suffix):
	...
	options = {
			...
			'outfile' : cpath + bench_name  + ".qasm.preprocessed",
	}
...
# curr_list = ["qft_n32_from_qiskit", "qft_n48_from_qiskit", "qft_n64_from_qiskit", "qft_n80_from_qiskit", "qft_n96_from_qiskit"]
